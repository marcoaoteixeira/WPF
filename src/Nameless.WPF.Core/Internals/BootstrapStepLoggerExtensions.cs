...
///     the <see cref="BootstrapStep"/> implementations.
/// </summary>
internal static class BootstrapStepLoggerExtensions {
    ...
    internal static void StartingExecution(this ILogger<BootstrapStep> self, BootstrapStep step) {
        StartingExecutionDelegate(self, step.Name, null /* exception */);
    }

    internal static void ExecutionFailure(this ILogger<BootstrapStep> self, BootstrapStep step, Exception exception) {
        ExecutionFailureDelegate(self, step.Name, exception);
    }

    internal static void ExecutionFinished(this ILogger<BootstrapStep> self, BootstrapStep step, TimeSpan duration) {
